...
class StatikComponent extends React.Component {
	...
	render() {
      ...
      <div className="header__left">
        <ul className="menu">
          ...
          <li className="menu-item-has-children"><a href="blog-grid.html">Blog</a><span className="sub-toggle"></span>
            <ul className="sub-menu">
      ...
      <div className="header__center">
        <div className="header__logo"><a className="ps-logo" href="index.html">
        <img src="assets/img/logo-dark.png" alt="" /></a></div>
      </div>
      <div className="header__right">
        <ul className="menu">
          <li><a href="brower-jobs.html">Job List</a></li>
          <li><a href="brower-freelancer.html">Freelancers</a></li>
          <li><a href="brower-employers.html">Employers</a></li>
        </ul>
        <div className="header__actions"><a className="ps-btn ps-btn--outline" href="signin-employee.html">Login</a><a className="ps-btn" href="signup-selection.html">Sign Up</a></div>
      </div>
    </header>
    <header className="header header--mobile" data-sticky="false">
      <div className="header__content">
        ...
        <div className="header__center"><a className="ps-logo" href="#"><img src="assets/img/logo-dark.png" alt="" /></a></div>
        <div className="header__right">
          <div className="header__actions"><a className="ps-search-btn" href="#"><i className="fa fa-search"></i></a></div>
        </div>
      </div>
    </header>
    ...
    <div id="homepage-1">
      <div className="ps-home-banner">
        ...
        <form className="ps-form--home-find-job" action="http://nouthemes.net/html/athena/index.html" method="get" data-wow-delay="0.25s" data-wow-duration="1s">
          <h1>Athena <br/> Freelancers</h1>
          ...
          <p>Update the latest jobs and announcements from Athena.<a href="#"> Join us today</a></p>
        </form>
      </div>
      ...
      <div className="ps-home-services">
        <div className="container ps-tab-root">
          ...
          <ul className="ps-tab-list">
            <li className="active"><a href="#tab-1"><span className="tab-icon"><i className="athena-browser-code"></i></span><span className="tab-title">Website Development</span><span className="tab-desc">Pellentesque vestibulum orci, id eleifend ante cursus vitae.</span></a></li>
      ...
      <div className="ps-home-join-us">
        <div className="container">
          <p>Millions of small businesses use <br/> Freelancer to turn their ideas into reality</p><a className="ps-btn ps-btn--gradient ps-btn--lg" href="#">Join athena today</a>
        </div>
      </div>
      <footer className="ps-footer">
        <div className="container">
          <div className="ps-footer__top"><a className="ps-logo" href="index.html"><img src="assets/img/logo-dark.png" alt="" /></a>
          ...
          <div className="ps-footer__bottom">
            <figure>
              ...
              <p>&copy; 2019 <a href="#">Athena</a> - All Rights Reserved. Made by <a href="#">Moontheme</a></p>
            </figure>
            <figure>
